          ...
          <>
            ...
            <div className="content mt-5">
              ...
              <p>
                ...
                clicking the &quot;Add&quot; button for pro or college teams.
                Feel free to only add a pro league or just some college teams.
                At least one team is required before submitting the form.
              </p>
            </div>
            <div className="field card is-shadowless">
              <div className="card-header is-shadowless has-background-light pt-2 px-2">
                <div className="tabs is-boxed">
                  <ul>
                    <li
                      className={clsx(teamView === LEAGUE.pro && "is-active")}
                    >
                    ...
                    <li
                      className={clsx(
                        teamView === LEAGUE.college && "is-active"
                      )}
                    >
              ...
              <div className="card-content">
                <p className={clsx(teamView !== LEAGUE.pro && "is-hidden")}>
                  If you&apos;re an artist and would like to create a new logo
                  for your team, be sure to let the commissioners when joining
                  our community on Slack. We love creativity!
                </p>
