...
import RecruitingRegionsSVG from "@assets/recruiting-regions_dark.svg";
...
<RecruitingRegionsSVG
  alt={
    "A map of the united states color-coded by the recruiting regions for the SICBA."
  }
/>
