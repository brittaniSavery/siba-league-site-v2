...
import RecruitingRegionsSVG_Dark from "@assets/recruiting-regions_dark.svg";
import RecruitingRegionsSVG_Light from "@assets/recruiting-regions_light.svg";
...
<SIBAPicture
  light={RecruitingRegionsSVG_Dark}
  dark={RecruitingRegionsSVG_Dark}
/>

**NOTE:** Each person is allowed to coach up to five (5) teams. Each team must have a different region from each other. You can have a single Tier 1 team, up to 2 Tier 2 teams, and up to 2 Tier 3 teams.
...
**<FontAwesomeIcon icon="fa-solid fa-xmark" color="danger" backText="Invalid - Shared Tiers" />**
...
**<FontAwesomeIcon icon="fa-solid fa-xmark" color="danger" backText="Invalid - Shared Regions" />**

- West Virginia
- <FontAwesomeIcon
    icon="fa-solid fa-xmark"
    color="danger"
    frontText="Georgia Tech"
  />
- <FontAwesomeIcon
    icon="fa-solid fa-xmark"
    color="danger"
    frontText="Alabama A&M"
  />

**<FontAwesomeIcon icon="fa-solid fa-check" color="success" backText="Valid" />**
