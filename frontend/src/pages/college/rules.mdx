import Layout from "@layouts/RulesLayout.astro";
import RulesIntro from "@components/utils/RulesIntro.astro";
import EventCalendar from "@components/EventCalendar/index.astro";
import FontAwesomeIcon from "@components/utils/FontAwesomeIcon";

<Layout title="SICBA Rules">

<RulesIntro league="college" slot="intro" />

<EventCalendar league="college" slot="calendar" />
