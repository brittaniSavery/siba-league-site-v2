...
import RecruitingDefinitions from "@components/EventCalendar/RecruitingDefinitions.astro";
import Legend from "@components/EventCalendar/Legend.astro";

<RulesIntro league="college" />
